...
export const api = {
  ...
  onModpackImportProgress: versions.onModpackImportProgress,
  ...
  listInstanceSchematics: content.listInstanceSchematics,
  ...
  backupWorld: content.backupWorld,
  listWorldBackups: content.listWorldBackups,
  restoreWorld: content.restoreWorld,
  deleteWorldBackup: content.deleteWorldBackup,
  importWorld: content.importWorld,
  deleteWorld: content.deleteWorld,
  renameWorld: content.renameWorld,
  duplicateWorld: content.duplicateWorld,
  ...
  getInstanceGroups: instances.getInstanceGroups,
  saveInstanceGroups: instances.saveInstanceGroups,
  ...
  listTrustedKeys: security.listTrustedKeys,
  addTrustedKey: security.addTrustedKey,
  removeTrustedKey: security.removeTrustedKey,
  verifyPluginSignature: security.verifyPluginSignature,
  ...
  downloadAuthlibInjector: auth.downloadAuthlibInjector,
  loginYggdrasil: auth.loginYggdrasil,
  ...
  getMirrorStats: system.getMirrorStats,
  ...
  /** Diagnose a crash from raw log content. */
  diagnoseCrashFromContent: crashApi.diagnoseCrashFromContent,
