...
export const getInstanceGroups = () => invoke<InstanceGroup[]>('get_instance_groups');
export const saveInstanceGroups = (groups: InstanceGroup[]) => invoke<void>('save_instance_groups', { groups });
