...
export async function batchPingServers(serverIds: number[], timeoutMs?: number): Promise<BatchPingResult[]> {
  return invoke<BatchPingResult[]>('batch_ping_servers', { serverIds, timeoutMs });
}
