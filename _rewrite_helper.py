#!/usr/bin/env python3
# Helper script to rewrite CHANGELOG.md and patch SECURITY.md
import os
...
BASE = "/Users/xiatian/Desktop/BonNext"
...
# Patch SECURITY.md: replace 0.1.x with 1.0.x in supported versions table
sec_path = os.path.join(BASE, "SECURITY.md")
with open(sec_path, "r", encoding="utf-8") as f:
    sec_content = f.read()

old_line = "| 0.1.x   | ✅ Active |"
new_line = "| 1.0.x   | ✅ Active |"
if old_line in sec_content:
    sec_content = sec_content.replace(old_line, new_line)
    with open(sec_path, "w", encoding="utf-8") as f:
        f.write(sec_content)
    print("SECURITY.md patched: 0.1.x -> 1.0.x")
else:
    print("WARNING: expected line not found in SECURITY.md")
